...
GSHEETS_DONATE_IN_KIND = os.getenv("GSHEETS_DONATE_IN_KIND")
GSHEETS_CONTACT_US = os.getenv("GSHEETS_CONTACT_US")
...
if ENVIRONMENT == "PROD":
    ...
    AZURE_URL_EXPIRATION_SECS = int(os.getenv("AZURE_URL_EXPIRATION_SECS")) # type: ignore
