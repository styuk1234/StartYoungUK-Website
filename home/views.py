...
from .models import Campaign, Coporate_sponsors
...
def home(request):
    coporate_sponsors = Coporate_sponsors.objects.all()
    ...
    return render(request, 'home.html', {'coporate_sponsors':coporate_sponsors,'top_donations':serial_donation, 'cnt_usr': cnt_usr, 'campaigns_zip': campaigns_zip, 'cnt_buddy': cnt_buddy, 'cnt_child': cnt_child})
