...
from users.models import StartYoungUKUsers
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            syuk_user.crn_no = form.cleaned_data.get('Company_Registration_Number')
            syuk_user.save()
    ...
    return render(request, 'users/register.html', {'form':form, 'name':'Corporate'})