...
def sdp(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, "Click on the Paypal button below to complete your SDP!")
            return render(request, 'sdp.html', {'form':form, 'paypal_btn': paypal_btn, 'is_buddy': request.user.startyoungukuser.is_buddy, 'sdp_frequency': sdp_frequency, 'sdp_amount': sdp_amount, 'button_enable': button_enable})
        else:
    ...
    return render(request, 'sdp.html', {'form':form, 'is_buddy': request.user.startyoungukuser.is_buddy, 'sdp_frequency': sdp_frequency, 'sdp_amount': sdp_amount})
